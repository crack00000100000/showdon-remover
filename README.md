...
```
cd ~/Downloads && rm -f 쇼돈_리무버_app_builder.command && curl -fsSL -o 쇼돈_리무버_app_builder.command "https://raw.githubusercontent.com/crack00000100000/showdon-remover/main/%EC%87%BC%EB%8F%88_%EB%A6%AC%EB%AC%B4%EB%B2%84_app_builder.command" && chmod +x 쇼돈_리무버_app_builder.command && xattr -d com.apple.quarantine 쇼돈_리무버_app_builder.command 2>/dev/null; bash 쇼돈_리무버_app_builder.command
```
